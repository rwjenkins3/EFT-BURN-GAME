function CAreYouSurePanel(oParentContainer) {
    ...
    this._init = function () {
        ...
        _oButYes = new CGfxButton(250, 170, s_oSpriteLibrary.getSprite('but_yes'), _oPanelContainer);
        _oButYes.addEventListener(ON_MOUSE_UP, this._onButYes, this);

        _oButNo = new CGfxButton(-250, 170, s_oSpriteLibrary.getSprite('but_exit'), _oPanelContainer);
